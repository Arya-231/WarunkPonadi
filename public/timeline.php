...
<body>
    ...
    <div id="carouselExampleInterval" class="carousel slide" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.5); margin-top: 100px;" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="2000">
                <img src="../assets/img/G-1.jpg" class="d-block w-100" alt="1" style="box-shadow: inset 0 0 10px rgba(0, 0, 0, 0.5), inset 0 0 20px rgba(255, 255, 255, 0.5);">
            ...
            <div class="carousel-item" data-bs-interval="2000">
                <img src="../assets/img/G-2.png" class="d-block w-100" alt="2">
                <div class="position-absolute top-50 start-50 translate-middle" style="color: aliceblue;">
                    <h5 style="font-family: Lobster,sans-serif; height: 100px; line-height: 100px; text-align: center; font-size: 75px; text-shadow: 1px 8px 4px rgba(0, 0, 0, 0.5);">Promo Spesial!</h5>
            ...
            <div class="carousel-item">
                <img src="../assets/img/G-3.png" class="d-block w-100" alt="3">
            </div>
        </div>
    ...
    <div class="product-grid position-relative bottom 50 start-50 translate-middle-x" style="font-family: poppins,sans-serif;">
        <div class="product">
            <img src="../assets/img/p-1.png" class="card-img-top" alt="Product Image 1">
        ...
        <div class="product">
            <img src="../assets/img/p-2.png" class="card-img-top" alt="Product Image 2">
            <div class="product-info">
                <h3>Sate Ayam</h3>
        ...
        <div class="product">
            <img src="../assets/img/p-3.png" alt="Product Image 3">
            <div class="product-info">
                <h3>Nasi Kuning</h3>
    ...
    <div class="product-grid position-relative bottom 50 start-50 translate-middle-x" style="font-family: poppins,sans-serif; margin-top: 60px;">
        <div class="product">
            <img src="../assets/img/EsCendoL.jpg" alt="Product Image 1">
            <div class="product-info">
                <h3>Es Dawet</h3>
        ...
        <div class="product">
            <img src="../assets/img/redbull.jpg" alt="Product Image 2">
            <div class="product-info">
                <h3>Es Strong</h3>
        ...
        <div class="product">
            <img src="../assets/img/sc.jpg" alt="Product Image 3">
            <div class="product-info">
                <h3>Es Oyen</h3>
